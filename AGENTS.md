# surgeist-style Repository Guide
...
This independent leaf repository owns its manifest, style-domain implementation,
public front door, focused tests and docs, commits, and published `main`
candidate.
...
`surgeist-style` owns the style model, cascade, resolution, validation, and
invalidation. It excludes authored CSS parsing and layout, text, and render
lowering. Surgeist-to-Surgeist lowering and adapters belong to root, and sibling
internals are not this repository's surface.
